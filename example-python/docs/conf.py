...
# -*- coding: utf-8 -*-
#
# example-python documentation build configuration file, created by
...
htmlhelp_basename = "example-pythondoc"
...
latex_documents = [
    (master_doc, "example-python.tex", "example-python Documentation",
     "Tim Paine", "manual"),
]
...
man_pages = [
    (master_doc, "example-python", "example-python Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "example-python", "example-python Documentation",
     author, "example-python", "An example instance of [timkpaine/pyproject-cookiecutter](https://github.com/timkpaine/pyproject-cookiecutter), for testing",
     "Miscellaneous"),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "example_python"))
