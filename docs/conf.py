...
# -*- coding: utf-8 -*-
#
# pyproject-cookiecutter-example documentation build configuration file, created by
...
htmlhelp_basename = "pyproject-cookiecutter-exampledoc"
...
latex_documents = [
    (master_doc, "pyproject-cookiecutter-example.tex", "pyproject-cookiecutter-example Documentation",
     "Tim Paine", "manual"),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "pyproject_cookiecutter_example"))
